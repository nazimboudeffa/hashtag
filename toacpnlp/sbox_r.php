...
<head>
    <title><? echo lang('dashboard'); ?> | Hashtag</title>
    <admin charset="UTF-8">
    <admin name="description" content="Hashtag is a social network platform helps you meet new friends and stay connected with your family and with who you are interested anytime anywhere.">
