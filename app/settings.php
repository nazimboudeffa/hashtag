...
<head>
    <title>Account settings | Hashtag</title>
    <meta charset="UTF-8">
    ...
    <meta name="keywords" content="settings,social network,social media,Hashtag,meet,free platform">
...
<div id="Language" class="tabcontent" style="height: auto;">
    ...
    <form action="" method="post">
        ...
        <select class="settings_textfield" name="edit_language">
            <option <?php if($_SESSION['language'] == "french"){ echo "selected";} ?> >Français</option>
            <option <?php if($_SESSION['language'] == "english"){ echo "selected";} ?> >English</option>
            <option <?php if($_SESSION['language'] == "arabic"){ echo "selected";} ?> >العربية</option>
        </select>
        </p>
        <div style="background: #e9ebee; border-radius: 3px; padding: 15px;">
