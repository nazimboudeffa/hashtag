...
<head>
    <title><?php echo "Hashtag - ".$_GET['tag'];if($_GET['tag'] == 'search'){echo "Hashtag";} ?> | Hashtag</title>
    <meta charset="UTF-8">
    ...
    <meta name="keywords" content="hashtag,social network,social media,Hashtag,meet,free platform">
