...
$.ajax({
    ...
    success:function(data){
     if (data =='') {
        $('#m_contacts_requests').html("<p style='margin: 0px 8px; text-align: center; color: grey; background: rgba(0, 0, 0, 0.03); padding: 8px 0px; border-radius: 3px;'><?php echo lang('nothingToShow'); ?></p>");
     }else{
...
$.ajax({
    ...
    beforeSend:function(){
        ...
        <div class="mCol3_userActive" style="background: #ccc;<?php echo lang('float2'); ?>:55%;"></div>
        </div>
