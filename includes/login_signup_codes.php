...
switch ($req) {
        ...
        if ($username == null && $password == null) {
            ...
            if (isset($_COOKIE['linAtt']) AND $_COOKIE['linAtt'] == $username) {
                ...
                if ($un_or_em != $username) {
                    ...
                    $checkAttempts = $con->prepare("SELECT login_attempts FROM users WHERE Username = :username");
                    ...
                    if ($login_attempts < 3) {
                        ...
                        $addAttempts = $con->prepare("UPDATE users SET login_attempts =:attempts WHERE Username=:username");
                    ...
                    if ($num == 0) {
                        ...
                        $_SESSION['attempts'] = 0;
                        include ("get_login_while_fetch.php");
                        echo "Welcome...";
                    }
                }
            }
    ...
    <ul class='alertRed' style='list-style:none;'>
        ...
        <li><span class='fa fa-times'></span> " . lang('signup_username_should_be_5') . ".</li>
            ...
            if ($cusers_q_num_rows < 1) {
                $signup_admin = "1";
                $signupsql = "INSERT INTO users (id,Fullname,Username,Email,Password,Userphoto,gender,language,admin)
    VALUES( :signup_id, :signup_fullname, :signup_username, :signup_email, :signup_password, :userphoto, :signup_gender,:signup_language,:signup_admin)";
                ...
                $signupsql = "INSERT INTO users (id,Fullname,Username,Email,Password,Userphoto,gender,language)
    VALUES( :signup_id, :signup_fullname, :signup_username, :signup_email, :signup_password, :userphoto, :signup_gender,:signup_language)";
            ...
            // ========================== login code after users ============================
            $loginsql = "SELECT * FROM users WHERE (Username= :signup_username OR Email= :signup_email) AND Password= :signup_password";
            $query = $con->prepare($loginsql);
            $query->bindParam(':signup_username', $signup_username, PDO::PARAM_STR);
            $query->bindParam(':signup_email', $signup_email, PDO::PARAM_STR);
            $query->bindParam(':signup_password', $signup_password, PDO::PARAM_STR);
