...
$chShare = $con->prepare("SELECT shared FROM posts WHERE shared=:get_post_id");
...
$fetch_shared = $con->prepare("SELECT * FROM posts WHERE post_id=:get_post_shared ");
